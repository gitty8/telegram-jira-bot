...
{
    internal class JiraMessageBuilder : BotMessageBuilder
    {
        ...
        {
            if (_update.Type != UpdateType.IssueChanged) return false;
        ...
        private void BuildCommentMessage()
        {
            ...
            Append(" commented on ");
            AppendIssueLink(comment.CommentUri, _issueKey);
            NewLine();
            AppendCommentBody();
        }
        ...
        private void AppendIssueTitle(Issue issue)
        {
            ...
            Append(" ");
            AppendIssueLink(issue.IssueUri, _issueKey);
            StartBold();
            Append(" was ");
